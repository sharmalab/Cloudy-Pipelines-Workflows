...
task quip_lymphocyte_segmentation {
  ...
  command {
    ...
    runtime {
      ...
      gpuCount: 1
      preemptible: 3
      zones: "us-east1-d us-east1-c us-central1-a us-central1-b us-west1-a us-west1-b"
...
workflow wf_quip_lymphocyte_segmentation{
  ...
  call quip_lymphocyte_segmentation {input: originalInput=imageToBeProcessed,imageInput=convert_out_maybe,result=resultName,BORBcompatible=BORBcompatible}
  output {
